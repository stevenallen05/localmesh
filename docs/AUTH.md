...
Implementation: [`localmesh/service_catalog/localmesh/`](../localmesh/service_catalog/localmesh/) (mesh plane — ingress + per-workload sidecar + egress; OIDC dance + JWT validation at the ingress role), [`localmesh/service_catalog/auth/`](../localmesh/service_catalog/auth/) (dex IdP), *Service mesh — local model* + *User identity at ingress* rows in [`DESIGN_DECISIONS.md`](./stakeholder/DESIGN_DECISIONS.md) · Take-home scope: [`TODO.md`](./TODO.md).
