...
Implementation: [`service_catalog/mesh/`](../service_catalog/mesh/) (envoy ingress + per-workload sidecar + egress; OIDC dance + JWT validation at the ingress role), [`service_catalog/auth/`](../service_catalog/auth/) (dex IdP), *Service mesh — local model* + *User identity at ingress* rows in [`DESIGN_DECISIONS.md`](./stakeholder/DESIGN_DECISIONS.md) · Take-home scope: [`TODO.md`](./TODO.md).
