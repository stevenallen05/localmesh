...
Implementation: [`localmesh/service_catalog/mesh/`](../localmesh/service_catalog/mesh/) (kuma-cp + per-workload kuma-dp dataplane + ingress MeshGateway; OIDC dance + JWT validation at the ingress dataplane), [`archive/legacy_plugins/auth/`](../archive/legacy_plugins/auth/) (dex IdP, archived pending a fresh design), *Service mesh — local model* + *User identity at ingress* rows in [`DESIGN_DECISIONS.md`](./stakeholder/DESIGN_DECISIONS.md) · Take-home scope: [`TODO.md`](./TODO.md).
